...
Because this is a financial-software community, we additionally treat the following
as unacceptable: knowingly promoting misleading financial claims (guaranteed
returns, fake audits, hidden fees), soliciting others to bypass jurisdictional
restrictions, or pressuring maintainers to weaken safety or honesty guarantees.
...
to the community leaders responsible for enforcement through GitHub's private
reporting tools on this repository (open a private report or contact a maintainer
listed in [MAINTAINERS.md](./MAINTAINERS.md)). All complaints will be reviewed and
...
Code of Conduct, for a specified period of time. This includes avoiding
