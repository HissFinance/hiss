...
- **Ship agent tooling** — an [MCP server](./docs/mcp.md) exposing 33 read/prepare
...
| [`@hiss-finance/mcp-server`](./docs/mcp.md)         | A local Model Context Protocol server exposing 33 read/prepare tools to any MCP-compatible agent. Read and prepare only — never executes.                            |
...
The server registers **33 tools** (18 read, 15 prepare). Representative tools:
